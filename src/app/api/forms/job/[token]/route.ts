...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      uploadLink: (job as any).uploadLink,
      mediaUploadLink: (job as any).mediaUploadLink,
      sitePOCName: (job as any).sitePOCName,
      sitePOCPhone: (job as any).sitePOCPhone,
      sitePOCEmail: (job as any).sitePOCEmail,
      lineItems: job.lineItems,
      customTodoItems: (job as any).customTodoItems,
