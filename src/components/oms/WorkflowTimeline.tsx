        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              if (newTemplateId) {
                handleTemplateAssign(newTemplateId)
              }
            }}
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Workflow will be assigned automatically when you select a template
          </p>
        </div>
      </div>
    )
      ...
      {isEditing && (
        <div className="mb-4 p-3 bg-gray-50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700 rounded-lg">
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">
              Workflow will be updated automatically when you select a template
            </p>
          </div>
        </div>
      )}
