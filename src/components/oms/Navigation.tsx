...
export function Navigation() {
  ...
  return (
    <>
      ...
      {/* Sidebar Navigation */}
      <nav className={`flex flex-col h-full transition-transform duration-300 ease-in-out lg:translate-x-0 ${
        isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
      } lg:relative fixed inset-y-0 left-0 z-40 bg-white dark:bg-gray-800`}>
      {/* Logo */}
